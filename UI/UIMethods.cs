...
internal static class UIMethods
{
    ...
    public static string GetDifficultyText(DifficultyLevel difficulty) => difficulty switch
    {
    ...
    public static int GetSortPriority(string propertyName) => propertyName switch
    {
        "难度" or "Difficulty" => 1,
        "开始时间" or "StartTime" => 4,
        "用时" or "Duration" => 3,
